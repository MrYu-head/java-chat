...
public class ClientLogin extends JFrame implements ActionListener{
	...
	public ClientLogin(String userName){
		...
		jlbl1=new JLabel(new ImageIcon("image/tou.gif"));
		this.add(jlbl1,"North");
	
		
		//创建中部组建
		jp2=new JPanel(new GridLayout(3,3));//布局的问题
		jlbl2=new JLabel("嘤YY号码",JLabel.CENTER);jlbl3=new JLabel("YY密码",JLabel.CENTER);
		...
		jtp1.add(jp2,"YY号码");jtp1.add(jp3,"手机号码");jtp1.add(jp4,"电子邮件");
		this.add(jtp1);
